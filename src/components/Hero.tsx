    ...
    <div className="relative min-h-screen flex items-center">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center">
        ...
        >
          ...
          <div className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-400 h-8">
            <Typewriter
              words={[
                ...
                'A systems engineer turned product leader'
              ]}
              loop={true}
              cursor
              cursorStyle='|'
          ...
          <div className="mt-10 flex justify-center space-x-6">
            <a
              ...
              className="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300 relative group"
            >
              <span className="sr-only">LinkedIn</span>
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
              </svg>
              <span className="absolute -bottom-8 left-1/2 -translate-x-1/2 px-2 py-1 bg-gray-800 text-white text-sm rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap">
                LinkedIn
              </span>
            </a>
            <a
